...
public class InvoiceTest {
    ...
    public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
        ...
        Assert.assertThat(invoice.getNetPrice(), Matchers.comparesEqualTo(invoice.getGrossPrice()));
    }
    ...
    public void testInvoiceHasProperSubtotalForManyProducts() {
        ...
        Assert.assertThat(invoice.getNetPrice(), Matchers.comparesEqualTo(new BigDecimal("310")));
    }
    ...
    public void testInvoiceHasProperTotalValueForManyProduct() {
        ...
        Assert.assertThat(invoice.getGrossPrice(), Matchers.comparesEqualTo(new BigDecimal("320.30")));
    }
